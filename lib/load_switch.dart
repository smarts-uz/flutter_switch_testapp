...
class LoadSwtich extends StatefulWidget {
  const LoadSwtich({Key? key}) : super(key: key);

  @override
  State<LoadSwtich> createState() => _LoadSwtichState();
}

class _LoadSwtichState extends State<LoadSwtich> {
  bool value = false;
