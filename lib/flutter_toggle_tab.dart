...
class ToglleTab extends StatefulWidget {
  const ToglleTab({super.key, required this.title});

  final String title;

  @override
  _ToglleTabState createState() => _ToglleTabState();
}

class _ToglleTabState extends State<ToglleTab> {
          ...
          ValueListenableBuilder(
            ...
            builder: (context, currentIndex, _) {
              return FlutterToggleTab(
                // width in percent
                icons: [Icons.abc, Icons.ac_unit],
                unSelectedBackgroundColors: [Colors.yellow],
                width: 90,
                borderRadius: 30,
                height: 50,
                isShadowEnable: true,
