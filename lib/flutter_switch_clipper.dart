...
class ClipperDart extends StatefulWidget {
  const ClipperDart({super.key});

  @override
  State<ClipperDart> createState() => _ClipperDartState();
}

class _ClipperDartState extends State<ClipperDart> {
      ...
      body: ListView(
        ...
        children: <Widget>[
          SwitchCipper(
            initSelect: true,
            child:
                const Icon(Icons.favorite, size: 200, color: Colors.redAccent),
            background:
